'''
Keygen for https://www.pdf-helper.com/pdf-to-x/ version 11.0 (Build 056)
...
def main():
    clear()
    print("Keygen PDF to X version 11.0 (Build 056)")
    print("software url https://www.pdf-helper.com/pdf-to-x/")
